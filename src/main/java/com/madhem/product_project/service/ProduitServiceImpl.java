...
public class ProduitServiceImpl implements ProduitService {
    ...
    @Override
    public List<Produit> findByNomContainNPrix(String nom, Double prix) {
        return produitRepository.findByNomContainNPrix(nom, prix);
    }

    @Override
    public List<Produit> findByCategorie(String nomCat) {
